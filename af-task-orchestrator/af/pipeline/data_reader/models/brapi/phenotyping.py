...
#   timestamp: 2021-03-24T19:59:51+00:00
# flake8: noqa
...
class Ontology(BaseModel):
    ...
    copyright: Optional[str] = Field(None, description="Ontology copyright", example="Copyright 1987, Bob Robertson")
    ...
    licence: Optional[str] = Field(None, description="Ontology licence", example="MIT Open source licence")
    ontologyDbId: str = Field(..., description="Ontology database unique identifier", example="18e186cd")
    ontologyName: str = Field(..., description="Ontology name", example="The Official Ontology")
    version: Optional[str] = Field(None, description="Ontology version (no specific format)", example="V1.3.2")
...
class ObservationTableObservationVariables(BaseModel):
    observationVariableDbId: Optional[str] = Field(None, description="Variable unique identifier", example="367aa1a9")
...
class Event(BaseModel):
    additionalInfo: Optional[Dict[str, AdditionalInfo]] = Field(None, description="Additional arbitrary info")
    ...
    eventDbId: str = Field(..., description="Internal database identifier", example="8566d4cb")
    ...
    studyDbId: Optional[str] = Field(None, description="The study in which the event occurred", example="2cc2001f")
...
class ObservationSearchRequest(
    ...
    observationLevelRelationships: Optional[List[ObservationUnitLevelRelationship]] = Field(
        None,
    ...
    observationTimeStampRangeEnd: Optional[datetime] = Field(None, description="Timestamp range end")
    observationTimeStampRangeStart: Optional[datetime] = Field(None, description="Timestamp range start")
    observationUnitDbIds: Optional[List[str]] = Field(
        None,
...
class ObservationVariableSearchRequest(SearchRequestParametersPaging, SearchRequestParametersExternalReferences):
...
class ImageNewRequest(BaseModel):
    additionalInfo: Optional[Dict[str, AdditionalInfo1]] = None
    ...
    imageFileSize: Optional[int] = Field(None, description="The size of the image in Bytes.", example=50000)
    imageHeight: Optional[int] = Field(None, description="The height of the image in Pixels.", example=550)
    ...
    imageTimeStamp: Optional[datetime] = Field(None, description="The date and time the image was taken")
    ...
    imageWidth: Optional[int] = Field(None, description="The width of the image in Pixels.", example=700)
...
class ImageSearchRequest(SearchRequestParametersPaging, SearchRequestParametersExternalReferences):
    descriptiveOntologyTerms: Optional[List[str]] = Field(
        None,
    ...
    imageFileSizeMin: Optional[int] = Field(None, description="A minimum image file size to search for.", example=1000)
    imageHeightMax: Optional[int] = Field(None, description="A maximum image height to search for.", example=1080)
    imageHeightMin: Optional[int] = Field(None, description="A minimum image height to search for.", example=720)
    ...
    imageTimeStampRangeEnd: Optional[datetime] = Field(None, description="The latest timestamp to search for.")
    imageTimeStampRangeStart: Optional[datetime] = Field(None, description="The earliest timestamp to search for.")
    imageWidthMax: Optional[int] = Field(None, description="A maximum image width to search for.", example=1920)
    imageWidthMin: Optional[int] = Field(None, description="A minimum image width to search for.", example=1280)
