...
class ObservationUnitObservationUnitPosition(BaseModel):
    ...
    geoCoordinates: Optional[GeoJSON] = Field()
    observationLevel: Optional[ObservationUnitLevel2] = Field()
    observationLevelRelationships:Optional[list[ObservationUnitLevelRelationship1]] = Field(
        None,
...
class SearchImagesBody(BaseModel):
    ...
    mimeTypes: Optional[List[constr]] = Field(
        None,
        pattern=r'image/.*',
...
class EntryType1(Enum):
    ...
    TEST = 'TEST'
    FILLER = 'FILLER'
    TEST2 = 'Test entry' #I assume they meant 'Test'
...
class Image(BaseModel):
    ...
    mimeType: Optional[constr] = Field(
        None,
        pattern=r'image/.*',
...
class MethodNewRequest(BaseModel):
    pydantic.RootModel: MethodBaseClass
...
class ObservationUnit(BaseModel):
    additionalInfo: Optional[Dict[str, str|None]] = Field(
        None,
        description='A free space containing any additional information related to a particular object. A data source may provide any JSON object, unrestricted by the BrAPI specification.',
    )
    ...
    observationUnitPosition: ObservationUnitObservationUnitPosition = Field(None)
...
class ScaleNewRequest(BaseModel):
    pydantic.RootModel: ScaleBaseClass


class TraitNewRequest(BaseModel):
    pydantic.RootModel: TraitBaseClass
...
class ObservationsPutRequest(BaseModel):
    pydantic.RootModel: Optional[Dict[str, ObservationNewRequest]] = None


class ObservationunitsPutRequest(BaseModel):
    pydantic.RootModel: Optional[Dict[str, ObservationUnitNewRequest]] = None
...
class ObservationUnitListResponse(BaseModel):
    field_context: Optional[Context] = Field(None, alias='@context')
    metadata: Metadata = Field(None)
    result: ObservationUnitListResponseResult = Field(None)
