...
#   timestamp: 2021-09-15T18:11:54+00:00
...
class BreedingMethod(BaseModel):
    abbreviation: Optional[str] = Field(
        None, description='an abbreviation for the name of this breeding method', example='MB'
    )
    breedingMethodDbId: str = Field(
        ..., description='the unique identifier for this breeding method', example='ffcce7ef'
    )
    breedingMethodName: Optional[str] = Field(
        None, description='human readable name of the breeding method', example='Male Backcross'
    )
...
class CrossParent(BaseModel):
    germplasmDbId: Optional[str] = Field(None, description='the unique identifier for a germplasm', example='d34b10c3')
    germplasmName: Optional[str] = Field(None, description='the human readable name for a germplasm', example='TME_419')
    observationUnitDbId: Optional[str] = Field(
        None, description='the unique identifier for an observation unit', example='2e1926a7'
    )
    observationUnitName: Optional[str] = Field(
        None, description='the human readable name for an observation unit', example='my_Plot_9001'
    )
    parentType: Optional[ParentType] = Field(
        None, description="The type of parent ex. 'MALE', 'FEMALE', 'SELF', 'POPULATION', etc.", example='MALE'
    )
...
class SearchRequestParametersCommonCropNames(BaseModel):
    commonCropNames: Optional[List[str]] = Field(
        None, description='Common name for the crop which this program is for', example=['Tomatillo', 'Paw Paw']
    )
...
class SearchRequestParametersLocations(BaseModel):
    locationDbIds: Optional[List[str]] = Field(
        None, description='The location ids to search for', example=['b28911cf', '5071d1e4']
    )
...
class SearchRequestParametersObservationVariables(BaseModel):
    observationVariableDbIds: Optional[List[str]] = Field(
        None, description='The DbIds of Variables to search for', example=['a646187d', '6d23513b']
    )
...
class SearchRequestParametersPaging(BaseModel):
    ...
    pageSize: Optional[int] = Field(
        None, description='The size of the pages to be returned. Default is `1000`.', example=1000
    )


class SearchRequestParametersPrograms(BaseModel):
    programDbIds: Optional[List[str]] = Field(
        None, description='A program identifier to search for', example=['8f5de35b', '0e2d4a13']
    )
...
class SearchRequestParametersStudies(BaseModel):
    studyDbIds: Optional[List[str]] = Field(
        None, description='List of study identifiers to search for', example=['cf6c4bd4', '691e69d6']
    )
...
class SearchRequestParametersTrials(BaseModel):
    trialDbIds: Optional[List[str]] = Field(
        None, description='The ID which uniquely identifies a trial to search for', example=['d2593dc2', '9431a731']
    )
...
class TaxonID(BaseModel):
    sourceName: str = Field(..., description='The human readable name of the taxonomy provider', example='NCBI')
    taxonId: str = Field(
        ...,
...
class DataFile(BaseModel):
    fileDescription: Optional[str] = Field(
        None, description='A human readable description of the file contents', example='This is an Excel data file'
    )
    ...
    fileName: Optional[str] = Field(None, description='The name of the file', example='datafile.xlsx')
    fileSize: Optional[int] = Field(None, description='The size of the file in bytes', example=4398)
    fileType: Optional[str] = Field(
        None, description='The type or format of the file. Preferably MIME Type.', example='application/vnd.ms-excel'
    )
...
class Position(BaseModel):
    __root__: List[float] = Field(
        ..., description='A single position', example=[-76.506042, 42.417373, 123], min_items=2
    )
...
class Status(BaseModel):
    ...
    messageType: MessageType = Field(..., description='The logging level for the attached message', example='INFO')


class TokenPagination(BasePagination):
    currentPageToken: Optional[str] = Field(
        None, description='The string token used to query the current page of data.', example='48bc6ac1'
    )
    nextPageToken: str = Field(
        ..., description='The string token used to query the next page of data.', example='cb668f63'
    )
    prevPageToken: Optional[str] = Field(
        None, description='The string token used to query the previous page of data.', example='9659857e'
    )


class CrossNewRequestCrossAttributes(BaseModel):
    crossAttributeName: Optional[str] = Field(
        None, description='the human readable name of a cross attribute', example='Humidity Percentage'
    )
    crossAttributeValue: Optional[str] = Field(None, description='the value of a cross attribute', example='45')


class ExternalReferencesInner(BaseModel):
    referenceID: Optional[str] = Field(
        None, description='The external reference ID. Could be a simple string or a URI.'
    )
    referenceSource: Optional[str] = Field(
        None, description='An identifier for the source system or database of this reference'
    )
...
class GermplasmMCPDCollectingInfo(BaseModel):
    ...
    collectingInstitutes: Optional[List[GermplasmMCPDCollectingInfoCollectingInstitutes]] = Field(
...
class GermplasmNewRequestStorageTypes(BaseModel):
    ...
    description: Optional[str] = Field(
        None, description='A supplemental text description of the storage type', example='Short term'
    )


class GermplasmNewRequestSynonyms(BaseModel):
    synonym: Optional[str] = Field(
        None, description='Alternative name or ID used to reference this germplasm', example='variety_1'
    )
    type: Optional[str] = Field(None, description='A descriptive classification for this synonym', example='Pre-Code')
...
class PedigreeNodeParents(BaseModel):
    germplasmDbId: Optional[str] = Field(
        None, description='The germplasm DbId of the parent of this germplasm', example='a55847ed'
    )
    germplasmName: Optional[str] = Field(
        None, description='the human readable name of the parent of this germplasm', example='A0000592'
    )
...
class PedigreeNodeSiblings(BaseModel):
    germplasmDbId: Optional[str] = Field(None, description='the germplasm DbId of the sibling')
    germplasmName: Optional[str] = Field(None, description='the germplasm name of the sibling')
...
class ProgenyNodeProgeny(BaseModel):
    germplasmDbId: str = Field(..., description='The unique identifier of a progeny germplasm', example='e8d5dad7')
    germplasmName: Optional[str] = Field(
        None, description='The human readable name of a progeny germplasm', example='A0021011'
    )
...
class ScaleBaseClassValidValues(BaseModel):
    categories: Optional[List[ScaleBaseClassValidValuesCategories]] = Field(
        ...
        example=[{'label': 'low', 'value': '0'}, {'label': 'medium', 'value': '5'}, {'label': 'high', 'value': '10'}],
    )
    max: Optional[int] = Field(None, description='Maximum value (used for field data capture control).', example=9999)
    min: Optional[int] = Field(
        None, description='Minimum value (used for data capture control) for numerical and date scales', example=2
    )
...
class ExternalReferences(BaseModel):
    __root__: List[ExternalReferencesInner] = Field(
        ...
        example=[
            ...
            {'referenceID': 'http://purl.obolibrary.org/obo/ro.owl', 'referenceSource': 'OBO Library'},
            {'referenceID': '75a50e76', 'referenceSource': 'Remote Data Collection Upload Tool'},
        ],
        title='ExternalReferences',
    )


class GermplasmAttributeSearchRequest(SearchRequestParametersPaging, SearchRequestParametersExternalReferences):
    attributeDbIds: Optional[List[str]] = Field(
        None, description='List of Germplasm Attribute IDs to search for', example=['2ef15c9f', '318e7f7d']
    )
    ...
    dataTypes: Optional[List[TraitDataType]] = Field(
        None, description='List of scale data types to filter search results', example=['Numerical', 'Ordinal', 'Text']
    )
    methodDbIds: Optional[List[str]] = Field(
        None, description='List of methods to filter search results', example=['07e34f83', 'd3d5517a']
    )
    ontologyDbIds: Optional[List[str]] = Field(
        None, description='List of ontology IDs to search for', example=['f44f7b23', 'a26b576e']
    )
    scaleDbIds: Optional[List[str]] = Field(
        None, description='List of scales to filter search results', example=['a13ecffa', '7e1afe4f']
    )
    studyDbId: Optional[List[str]] = Field(
        None, description='The unique ID of a studies to filter on', example=['5bcac0ae', '7f48e22d']
    )
    ...
    traitDbIds: Optional[List[str]] = Field(
        None, description='List of trait unique ID to filter search results', example=['ef81147b', '78d82fad']
    )


class GermplasmAttributeValueNewRequest(BaseModel):
    additionalInfo: Optional[Dict[str, str]] = Field(None, description='Additional arbitrary info')
    ...
    attributeName: str = Field(..., description='A human readable name for this attribute', example='Weevil Resistance')
    determinedDate: Optional[datetime] = Field(
        None, description='The date the value of this attribute was determined for a given germplasm'
    )
    ...
    value: Optional[str] = Field(
        None, description='The value of this attribute for a given germplasm', example='Present'
    )


class GermplasmAttributeValueSearchRequest(
    SearchRequestParametersPaging, SearchRequestParametersGermplasm, SearchRequestParametersExternalReferences
):
    attributeDbIds: Optional[List[str]] = Field(
        None, description='List of Germplasm Attribute IDs to search for', example=['2ef15c9f', '318e7f7d']
    )
    ...
    attributeValueDbIds: Optional[List[str]] = Field(
        None, description='List of Germplasm Attribute Value IDs to search for', example=['ca4636d0', 'c8a92409']
    )
    dataTypes: Optional[List[TraitDataType]] = Field(
        None, description='List of scale data types to filter search results', example=['Numerical', 'Ordinal', 'Text']
    )
...
class GermplasmMCPD(BaseModel):
    ...
    germplasmDbId: Optional[str] = Field(
        None, description='A unique identifier which identifies a germplasm in this database', example='31c4efbc'
    )
    germplasmPUI: Optional[str] = Field(
        None,
    ...
    safetyDuplicateInstitutes: Optional[List[GermplasmMCPDSafetyDuplicateInstitutes]] = None
    ...
    speciesAuthority: Optional[str] = Field(
        None, description='MCPD (v2.1) (SPAUTHOR) 7. Provide the authority for the species name.', example='Smith, 1822'
    )
...
class GermplasmSearchRequest(
    ...
    accessionNumbers: Optional[List[str]] = Field(
        None, description='List unique identifiers for accessions within a genebank', example=['A0000003', 'A0000477']
    )
    ...
    genus: Optional[List[str]] = Field(
        None, description='List of Genus names to identify germplasm', example=['Aspergillus', 'Zea']
    )
    ...
    parentDbIds: Optional[List[str]] = Field(
        None, description='Search for Germplasm with these parents', example=['72c1001f', '7346c553']
    )
    progenyDbIds: Optional[List[str]] = Field(
        None, description='Search for Germplasm with these children', example=['16e16a7e', 'ce06cf9e']
    )
    species: Optional[List[str]] = Field(
        None, description='List of Species names to identify germplasm', example=['fructus', 'mays']
    )
...
class OntologyReference(BaseModel):
    ...
    ontologyDbId: str = Field(..., description='Ontology database unique identifier', example='6b071868')
    ontologyName: str = Field(..., description='Ontology name', example='The Crop Ontology')
    version: Optional[str] = Field(None, description='Ontology version (no specific format)', example='7.2.3')


class PedigreeNode(BaseModel):
    crossingProjectDbId: Optional[str] = Field(
        None, description='The crossing project used to generate this germplasm', example='625e745a'
    )
    crossingYear: Optional[int] = Field(None, description='The year the parents were originally crossed', example=2005)
    familyCode: Optional[str] = Field(None, description='The code representing the family', example='F0000203')
    germplasmDbId: str = Field(..., description='The ID which uniquely identifies a germplasm', example='1098ebaf')
    germplasmName: Optional[str] = Field(None, description='A human readable name for a germplasm', example='A0021004')
    parents: Optional[List[PedigreeNodeParents]] = Field(
        None,
        description='List of parent nodes in the pedigree tree.',
        example=[
            {'germplasmDbId': 'b66958de', 'germplasmName': 'A0000592', 'parentType': 'MALE'},
            {'germplasmDbId': 'a55847ed', 'germplasmName': 'A0000592', 'parentType': 'FEMALE'},
        ],
    )
    pedigree: Optional[str] = Field(
        None, description='The string representation of the pedigree.', example='A0000001/A0000002'
    )
...
class PlannedCrossNewRequest(BaseModel):
    additionalInfo: Optional[Dict[str, str]] = Field(None, description='Additional arbitrary info')
    crossType: Optional[CrossType1] = Field(None, description='the type of cross', example='BIPARENTAL')
    crossingProjectDbId: Optional[str] = Field(
        None, description='the unique identifier for a crossing project', example='696d7c92'
    )
    crossingProjectName: Optional[str] = Field(
        None, description='the human readable name for a crossing project', example='my_Crosses_2018'
    )
    externalReferences: Optional[ExternalReferences] = None
    parent1: Optional[CrossParent] = None
    parent2: Optional[CrossParent] = None
    plannedCrossName: Optional[str] = Field(
        None, description='the human readable name for a cross', example='my_Crosses_2018_01'
    )


class ProgenyNode(BaseModel):
    germplasmDbId: str = Field(..., description='The ID which uniquely identifies a germplasm', example='01b974dc')
    germplasmName: Optional[str] = Field(None, description='A human readable name for a germplasm', example='A0021004')
    progeny: List[ProgenyNodeProgeny] = Field(
        ...,
        description='List of germplasm entities which are direct children of this germplasm',
        example=[
            {'germplasmDbId': 'e8d5dad7', 'germplasmName': 'A0021011', 'parentType': 'FEMALE'},
            {'germplasmDbId': 'ac07fbd8', 'germplasmName': 'A0021012', 'parentType': 'FEMALE'},
            {'germplasmDbId': '07f45f67', 'germplasmName': 'A0021013', 'parentType': 'FEMALE'},
        ],
    )
...
class ScaleBaseClass(BaseModel):
    ...
    decimalPlaces: Optional[int] = Field(
        None, description='For numerical, number of decimal places to be reported', example=2
    )
    externalReferences: Optional[ExternalReferences] = None
...
class SeedLotNewRequest(BaseModel):
    ...
    createdDate: Optional[datetime] = Field(None, description='The time stamp for when this seed lot was created')
    externalReferences: Optional[ExternalReferences] = None
    germplasmDbId: Optional[str] = Field(
        None, description='Unique DbId of the Germplasm held in this Seed Lot', example='029d705d'
    )
    lastUpdated: Optional[datetime] = Field(
        None, description='The timestamp for the last update to this Seed Lot (including transactions)'
    )
    locationDbId: Optional[str] = Field(None, description='DbId of the storage location', example='7989c44c')
    programDbId: Optional[str] = Field(
        None, description='Unique DbId of the breeding Program this Seed Lot belongs to', example='e972d569'
    )
    seedLotDescription: Optional[str] = Field(
        None, description='A general description of this Seed Lot', example='This is a description of a seed lot'
    )
    seedLotName: Optional[str] = Field(
        None, description='A human readable name for this Seed Lot', example='Seed Lot Alpha'
    )
...
class SeedLotNewTransactionRequest(BaseModel):
    ...
    fromSeedLotDbId: Optional[str] = Field(
        None, description='The identifier for the Seed Lot being transfered out of', example='11eef13b'
    )
    toSeedLotDbId: Optional[str] = Field(
        None, description='The identifier for the Seed Lot being transfered into', example='59339b90'
    )
    transactionDescription: Optional[str] = Field(
        None, description='A general description of this Seed Lot Transaction', example='f9cd88d2'
    )
...
class SeedLotTransaction(SeedLotNewTransactionRequest):
    transactionDbId: str = Field(..., description='Unique DbId for the Seed Lot Transaction', example='28e46db9')
...
class TraitBaseClass(BaseModel):
    ...
    mainAbbreviation: Optional[str] = Field(
        None, description='Main abbreviation for trait name. (examples: "Carotenoid content" => "CC")', example='PH'
    )
    ontologyReference: Optional[OntologyReference] = None
    status: Optional[str] = Field(
        None, description='Trait status (examples: "recommended", "obsolete", "legacy", etc.)', example='recommended'
    )
    synonyms: Optional[List[str]] = Field(
        None, description='Other trait names', example=['Height', 'Plant Height', 'Stalk Height', 'Canopy Height']
    )
    ...
    traitDescription: Optional[str] = Field(
        None, description='The description of a trait', example='The height of the plant'
    )
...
class Trait1(TraitBaseClass):
    traitDbId: Optional[str] = Field(None, description='The ID which uniquely identifies a trait', example='9b2e34f5')
...
class PointGeometry(BaseModel):
    ...
    type: Optional[str] = Field('Point', description='The literal string "Point"', example='Point')
...
class PolygonGeometry(BaseModel):
    ...
    type: Optional[str] = Field('Polygon', description='The literal string "Polygon"', example='Polygon')
...
class CrossNewRequest(BaseModel):
    ...
    crossType: Optional[CrossType] = Field(None, description='the type of cross', example='BIPARENTAL')
    crossingProjectDbId: Optional[str] = Field(
        None, description='the unique identifier for a crossing project', example='696d7c92'
    )
    crossingProjectName: Optional[str] = Field(
    ...
    parent1: Optional[CrossParent] = None
    parent2: Optional[CrossParent] = None
    pollinationTimeStamp: Optional[datetime] = Field(None, description='the timestamp when the pollination took place')


class CrossingProjectNewRequest(BaseModel):
    additionalInfo: Optional[Dict[str, str]] = Field(None, description='Additional arbitrary info')
    commonCropName: Optional[str] = Field(
        None, description='the common name of a crop (for multi-crop systems)', example='Cassava'
    )
    ...
    crossingProjectName: Optional[str] = Field(
        None, description='the human readable name for a crossing project', example='Crosses_2018'
    )
    externalReferences: Optional[ExternalReferences] = None
    programDbId: Optional[str] = Field(None, description='the unique identifier for a program', example='a088176c')
    programName: Optional[str] = Field(
        None, description='the human readable name for a program', example='IITA Cassava'
    )
...
class PlannedCross(PlannedCrossNewRequest):
    plannedCrossDbId: Optional[str] = Field(None, description='the unique identifier for a cross', example='c8905568')
...
class SeedLot(SeedLotNewRequest):
    seedLotDbId: str = Field(..., description='Unique DbId for the Seed Lot', example='261ecb09')
...
class Method1(MethodBaseClass):
    methodDbId: Optional[str] = Field(None, description='Method unique identifier', example='0adb2764')


class VariableBaseClass(BaseModel):
    additionalInfo: Optional[Dict[str, str]] = Field(None, description='Additional arbitrary info')
    commonCropName: Optional[str] = Field(None, description='Crop name (examples: "Maize", "Wheat")', example='Maize')
    ...
    defaultValue: Optional[str] = Field(
        None, description='Variable default value. (examples: "red", "2.3", etc.)', example='2.0'
    )
    ...
    growthStage: Optional[str] = Field(
        None, description='Growth stage at which measurement is made (examples: "flowering")', example='flowering'
    )
    institution: Optional[str] = Field(
        None, description='Name of institution submitting the variable', example='The BrAPI Institute'
    )
    language: Optional[str] = Field(
        None, description='2 letter ISO 639-1 code for the language of submission of the variable.', example='en'
    )
    method: Method1
    ontologyReference: Optional[OntologyReference] = None
    scale: Scale1
    scientist: Optional[str] = Field(
        None, description='Name of scientist submitting the variable.', example='Dr. Bob Robertson'
    )
    status: Optional[str] = Field(
        None,
    ...
    synonyms: Optional[List[str]] = Field(
        None, description='Other variable names', example=['Maize Height', 'Stalk Height', 'Corn Height']
    )
    trait: Trait1
...
class GeoJSON(BaseModel):
    ...
    type: Optional[str] = Field('Feature', description='The literal string "Feature"', example='Feature')
...
class Cross(CrossNewRequest):
    crossDbId: Optional[str] = Field(None, description='the unique identifier for a cross', example='d105fd6f')


class CrossingProject(CrossingProjectNewRequest):
    crossingProjectDbId: Optional[str] = Field(
        None, description='the unique identifier for a crossing project', example='ce0e1c29'
    )


class GermplasmAttributeNewRequest(VariableBaseClass):
    attributeCategory: Optional[str] = Field(
        None, description='General category for the attribute. very similar to Trait class.', example='Morphological'
    )
    ...
    attributeName: str = Field(..., description='A human readable name for this attribute', example='Plant Height 1')
...
class GermplasmNewRequest(BaseModel):
    ...
    biologicalStatusOfAccessionDescription: Optional[str] = Field(
        None, description="Supplemental text description for 'biologicalStatusOfAccessionCode'", example='Genetic stock'
    )
    ...
    defaultDisplayName: Optional[str] = Field(
        None, description='Human readable name used for display purposes', example='A0000003'
    )
    documentationURL: Optional[AnyUrl] = Field(
        None, description='A URL to the human readable documentation of this object', example='https://wiki.brapi.org'
    )
    donors: Optional[List[GermplasmNewRequestDonors]] = Field(None, description='List of donor institutes')
    externalReferences: Optional[ExternalReferences] = None
    genus: Optional[str] = Field(
        None,
    ...
    instituteName: Optional[str] = Field(
        None, description='The name of the institute that maintains the material', example='The BrAPI Institute'
    )
    pedigree: Optional[str] = Field(
        None,
    ...
    seedSource: Optional[str] = Field(None, description='The source of the seed ', example='A0000001/A0000002')
    ...
    storageTypes: Optional[List[GermplasmNewRequestStorageTypes]] = Field(
        ...
        example=[{'code': '20', 'description': 'Field collection'}, {'code': '11', 'description': 'Short term'}],
    )
