...
class CrossesPutRequest(BaseModel):
    pydantic.RootModel: Optional[Dict[str, CrossNewRequest]] = None


class PedigreePutRequest(BaseModel):
    pydantic.RootModel: Optional[Dict[str, PedigreeNode]] = None


class PlannedcrossesPutRequest(BaseModel):
    pydantic.RootModel: Optional[Dict[str, PlannedCrossNewRequest]] = None
