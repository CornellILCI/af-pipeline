...
#   timestamp: 2021-03-24T20:00:22+00:00
# flake8: noqa
...
class DataLink(BaseModel):
    ...
    provenance: Optional[str] = Field(
        ...
        example="Image Processing af.pipeline, built at the University of Antarctica: https://github.com/antarctica/pipeline",
    )
...
class EnvironmentParameter(BaseModel):
    ...
    unit: Optional[str] = Field(None, description="Unit of the value for this parameter", example="pH")
...
class AdditionalInfo2(BaseModel):
    class Config:
        extra = Extra.allow
...
class AdditionalInfo3(BaseModel):
    class Config:
        extra = Extra.allow
...
class AdditionalInfo4(BaseModel):
    class Config:
        extra = Extra.allow
...
class AdditionalInfo5(BaseModel):
    class Config:
        extra = Extra.allow
...
class Season(BaseModel):
    ...
    year: Optional[int] = Field(None, description="The 4 digit year of the season.", example=2018)
...
class AdditionalInfo6(BaseModel):
    class Config:
        extra = Extra.allow
...
class StudySearchRequest(
    ...
    active: Optional[bool] = Field(None, description="Is this study currently active", example=True)
    observationVariableDbIds: Optional[List[str]] = Field(
        None,
    ...
    sortOrder: Optional[SortOrder] = Field(None, description='Order results should be sorted. ex. "ASC" or "DESC"')
...
class AdditionalInfo7(BaseModel):
    class Config:
        extra = Extra.allow
...
class AdditionalInfo8(BaseModel):
    class Config:
        extra = Extra.allow
...
class TrialSearchRequest(
    ...
    active: Optional[bool] = Field(None, description="Is this trail currently active", example=True)
...
class AdditionalInfo9(BaseModel):
    class Config:
        extra = Extra.allow
...
class ListBaseFields(BaseModel):
    ...
    dateCreated: Optional[datetime] = Field(None, description="Timestamp when the entity was first created")
    dateModified: Optional[datetime] = Field(None, description="Timestamp when the entity was last updated")
    ...
    listSize: Optional[int] = Field(None, description="The number of elements in a List", example=53)
...
class ListSearchRequest(SearchRequestParametersPaging, SearchRequestParametersExternalReferences):
    ...
    listNames: Optional[List[str]] = Field(None, example=["Planing List 1", "Bobs List"])
    listOwnerNames: Optional[List[str]] = Field(None, example=["Bob Robertson", "Rob Robertson"])
    listOwnerPersonDbIds: Optional[List[str]] = Field(None, example=["bob@bob.com", "rob@bob.com"])
    listSources: Optional[List[str]] = Field(None, example=["USER", "SYSTEM", "EXTERNAL"])
    listType: Optional[ListTypes] = None


class ListSummary(ListBaseFields):
    listDbId: str = Field(..., description="The unique identifier for a List", example="6f621cfa")
...
class PersonNewRequest(BaseModel):
    additionalInfo: Optional[Dict[str, AdditionalInfo3]] = Field(None, description="Additional arbitrary info")
    description: Optional[str] = Field(
        None,
        description="description of this person",
        example="Bob likes pina coladas and getting caught in the rain.",
    )
    emailAddress: Optional[str] = Field(None, description="email address for this person", example="bob@bob.com")
    externalReferences: Optional[ExternalReferences] = None
    firstName: Optional[str] = Field(None, description="Persons first name", example="Bob")
    lastName: Optional[str] = Field(None, description="Persons last name", example="Robertson")
    mailingAddress: Optional[str] = Field(
        None,
        description="physical address of this person",
        example="123 Street Ave, City, State, Country",
    )
    middleName: Optional[str] = Field(None, description="Persons middle name", example="Danger")
    phoneNumber: Optional[str] = Field(None, description="phone number of this person", example="+1-555-555-5555")
...
class PersonSearchRequest(SearchRequestParametersPaging, SearchRequestParametersExternalReferences):
    emailAddresses: Optional[List[str]] = Field(
        None,
        description="email address for this person",
        example=["bob@bob.com", "rob@bob.com"],
    )
    firstNames: Optional[List[str]] = Field(None, description="Persons first name", example=["Bob", "Rob"])
    lastNames: Optional[List[str]] = Field(None, description="Persons last name", example=["Robertson", "Smith"])
    mailingAddresses: Optional[List[str]] = Field(
        None,
        description="physical address of this person",
        example=["123 Main Street", "456 Side Street"],
    )
    middleNames: Optional[List[str]] = Field(None, description="Persons middle name", example=["Danger", "Fight"])
...
class ProgramNewRequest(BaseModel):
    abbreviation: Optional[str] = Field(None, description="An abbreviation which represents this program", example="P1")
    additionalInfo: Optional[Dict[str, AdditionalInfo4]] = Field(None, description="Additional arbitrary info")
    ...
    leadPersonName: Optional[str] = Field(None, description="The name of the program leader", example="Bob Robertson")
...
class ScaleBaseClass(BaseModel):
    additionalInfo: Optional[Dict[str, AdditionalInfo5]] = Field(None, description="Additional arbitrary info")
...
class StudyNewRequest(BaseModel):
    active: Optional[bool] = Field(None, description="Is this study currently active", example=True)
    additionalInfo: Optional[Dict[str, AdditionalInfo6]] = Field(None, description="Additional arbitrary info")
    commonCropName: Optional[str] = Field(
        None,
        description="Common name for the crop associated with this study",
        example="Grape",
    )
    contacts: Optional[List[Contact]] = Field(None, description="List of contact entities associated with this study")
    ...
    locationDbId: Optional[str] = Field(None, description="The unique identifier for a Location", example="3cfdd67d")
    ...
    trialDbId: Optional[str] = Field(None, description="The ID which uniquely identifies a trial", example="48b327ea")
...
class TraitBaseClass(BaseModel):
    additionalInfo: Optional[Dict[str, AdditionalInfo7]] = Field(None, description="Additional arbitrary info")
...
class TrialNewRequest(BaseModel):
    active: Optional[bool] = Field(None, description="Is this trail currently active", example=True)
    additionalInfo: Optional[Dict[str, AdditionalInfo8]] = Field(None, description="Additional arbitrary info")
    commonCropName: Optional[str] = Field(
        None,
        description="Common name for the crop associated with this trial",
        example="Wheat",
    )
    contacts: Optional[List[Contact]] = Field(None, description="List of contact entities associated with this trial")
    ...
    externalReferences: Optional[ExternalReferences] = None
    programDbId: Optional[str] = Field(None, description="A program identifier to search for", example="673f378a")
    programName: Optional[str] = Field(
        None,
        description="Human readable name of the program",
        example="Tomatillo_Breeding_Program",
...
class MethodBaseClass(BaseModel):
    additionalInfo: Optional[Dict[str, AdditionalInfo2]] = Field(None, description="Additional arbitrary info")
...
class Person(PersonNewRequest):
    personDbId: str = Field(..., description="Unique ID for a person", example="14340a54")
...
class ServerInfo(BaseModel):
    calls: List[Service] = Field(..., description="Array of available calls on this server")
    ...
    serverName: Optional[str] = Field(None, description="The name of this server", example="The BrAPI Test Server")
...
class VariableBaseClass(BaseModel):
    additionalInfo: Optional[Dict[str, AdditionalInfo9]] = Field(None, description="Additional arbitrary info")
...
class LocationNewRequest(BaseModel):
    ...
    additionalInfo: Optional[Dict[str, AdditionalInfo1]] = Field(
        None, description="Additional arbitrary info", example={}
    )
...
class LocationSearchRequest(
    ...
    altitudeMax: Optional[float] = Field(None, description="The maximum altitude to search for", example=200)
    altitudeMin: Optional[float] = Field(None, description="The minimum altitude to search for", example=20)
