...
class Config(Base):
    __tablename1__ = "property"  # Base.metadata.tables["af.property"]
    __tablename2__ = "property_meta"  # Base.metadata.tables["af.property_meta"]
    __tablename3__ = "property_config"  # Base.metadata.tables["af.request"]
