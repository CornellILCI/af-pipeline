...
(
	record integer NULL,
	trait_value double precision NULL,
	yhat double precision NULL,
	residual double precision NULL,
	hat double precision NULL,
	plot_id integer NULL,
	rinv_res double precision NULL,
	amostat double precision NULL,
	amostat_flag varchar(50) NULL,
	stat_factor varchar(50) NULL,
	covariate_trait_value double precision NULL,
	trait_qc varchar(50) NULL,
	covariate_trait_qc varchar(50) NULL,
...
(
	...
	std_error double precision NULL,
	e_code varchar(50) NULL,
	ci95_upper double precision NULL,
	ci95_lower double precision NULL,
	tenant_id integer NOT NULL,	-- Id of the selected Tenant
	creation_timestamp timestamp without time zone NOT NULL   DEFAULT now(),	-- Timestamp when the record was added to the table
	modification_timestamp timestamp without time zone NULL,	-- Timestamp when the record was last modified
	creator_id integer NOT NULL,	-- ID of the user who added the record to the table
