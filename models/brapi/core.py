...
class PersonNewRequest(BaseModel):
    additionalInfo: Optional[Dict[str, AdditionalInfo3]] = Field(
...
class ProgramNewRequest(BaseModel):
    ...
    additionalInfo: Optional[Dict[str, AdditionalInfo4]] = Field(
        None, description='Additional arbitrary info'
    )
...
class ScaleBaseClass(BaseModel):
    additionalInfo: Optional[Dict[str, AdditionalInfo5]] = Field(
        None, description='Additional arbitrary info'
    )
...
class StudyNewRequest(BaseModel):
    ...
    additionalInfo: Optional[Dict[str, AdditionalInfo6]] = Field(
        None, description='Additional arbitrary info'
    )
    commonCropName: Optional[str] = Field(
        None,
...
class TraitBaseClass(BaseModel):
    additionalInfo: Optional[Dict[str, AdditionalInfo7]] = Field(
        None, description='Additional arbitrary info'
    )
...
class TrialNewRequest(BaseModel):
    ...
    additionalInfo: Optional[Dict[str, AdditionalInfo8]] = Field(
        None, description='Additional arbitrary info'
    )
    commonCropName: Optional[str] = Field(
        None,
...
class MethodBaseClass(BaseModel):
    additionalInfo: Optional[Dict[str, AdditionalInfo2]] = Field(
        None, description='Additional arbitrary info'
    )
...
class VariableBaseClass(BaseModel):
    additionalInfo: Optional[Dict[str, AdditionalInfo9]] = Field(
        None, description='Additional arbitrary info'
    )
    commonCropName: Optional[str] = Field(
