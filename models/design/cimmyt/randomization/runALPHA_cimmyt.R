...
# Script Version   : 2
# SYNTAX_EXAMPLE  : "Rscript runALPHA_cimmyt.R -n 45 -b 3 -k 5 -t 3 --nFieldRow 9 --nPlotBarrier 5"
# -------------------------------------------------------------------------------------
# Parameters:
...
optionList <- list(
  make_option(opt_str = c("-n","--nTreatment"), type = "integer", default = 10000,
  ...
  make_option(opt_str = c("-k","--sBlk"), type = "integer", default = 50000,
